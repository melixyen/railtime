...
(function(wind){
    function canvasMap(cfg){
        ...
        defaultCfg = {
            ...
            baseHeight: 3730,//canvas 畫布高
            canTouch: ("ontouchend" in document),
            canvasBgcolor: 'rgba(255,255,255,0.9)',
            canvasID: null,//canvas 的 id，不需要則為 null
            companyNameObj: {tra: '台鐵', trtc: '北捷', ntmetro: '新北', thsr: '高鐵', tymetro: '桃捷', crtc: '中捷', krtc: '高捷'},
            ...
            stationClassFontSize: [19.5,17,16,14.5,12,10.5,8],
            stationClassFontMaxWidth: [100,90,80,80,70,60,50],
            stationNameColor: '#000',
            stationNameHoverEffect: 1,//0 無效果，1 移上時加框
        ...
        var pos = {
            badu: {x: 650, y: -240},
            hualian: {x: 820, y: 870},
            taidong: {x: 820, y: 1920},
            tauoyuan: {x: -240, y: 630},
            hsinchu: {x: -240, y: 1100},
            taichung: {x: 100, y: 1630},
            changhua: {x: -240, y: 1880},
            chayi: {x: -170, y: 2280},
            tainan: {x: -400, y: 2580},
            kaohsiung: {x: -300, y: 3080},
            pingdong: {x: 350, y: 3080}
        }
        if(cfg.linePOS) pos = cfg.linePOS;
        
        if(cfg.stationNameHoverEffect){
            switch(cfg.stationNameHoverEffect){
                case 1:
                    var cssStr = 'div.' + cfg.makeClickBaseCSSName + ':hover{ background-color: rgba(233, 246, 8, 0.25); }';
                    if(cfg.stationNameRenderStyle==1 || cfg.stationNameRenderStyle==3){
                        cssStr = 'div.' + cfg.makeClickBaseCSSName + ':hover{ border: 2px solid #2cecfc; box-sizing: border-box; }';
                    }
            ...
            tra: [
                {
                    ...
                    station: {
                        ...
                        "tra_1325": {x: pos.taichung.x, y: pos.taichung.y-160, name: '栗林', stationClass: 4 },
                        "tra_1318": {x: pos.taichung.x, y: pos.taichung.y-135, name: '潭子', stationClass: 4 },
                        "tra_1326": {x: pos.taichung.x, y: pos.taichung.y-110, name: '頭家厝', stationClass: 4 },
                        "tra_1327": {x: pos.taichung.x, y: pos.taichung.y-85, name: '松竹', stationClass: 3, company: true},
                        "tra_1323": {x: pos.taichung.x, y: pos.taichung.y-60, name: '太原', stationClass: 4 },
                        "tra_1328": {x: pos.taichung.x, y: pos.taichung.y-35, name: '精武', stationClass: 4 },
                        "tra_1319": {x: pos.taichung.x, y: pos.taichung.y, name: '台中', stationClass: 1, company: true},
                        "tra_1329": {x: pos.taichung.x, y: pos.taichung.y+35, name: '五權', stationClass: 4 },
                    ...
                    line: [
                        ...
                        {type: 'station', id: 'tra_1245'},
                        {type: 'station', id: 'tra_1246'},
                        {type: 'station', id: 'tra_1237'},
                        {type: 'station', id: 'tra_1247'},
                    ...
                    station: {
                        ...
                        "tra_1236": {x: pos.kaohsiung.x-100, y: pos.kaohsiung.y-150, name: '左營', stationClass: 4, company: true},
                        "tra_1245": {x: pos.kaohsiung.x-220, y: pos.kaohsiung.y-120, name: '內惟', stationClass: 4 },
                        "tra_1246": {x: pos.kaohsiung.x-250, y: pos.kaohsiung.y-85, name: '美術館', stationClass: 4, company: true},
                        "tra_1237": {x: pos.kaohsiung.x-250, y: pos.kaohsiung.y-46, name: '鼓山', stationClass: 4, company: true},
                        "tra_1247": {x: pos.kaohsiung.x-100, y: pos.kaohsiung.y-46, name: '三塊厝', stationClass: 4 },
                    ...
                    line: [
                        {type: 'station', id: 'tra_1238'},
                        {type: 'station', id: 'tra_1411'},
                        {type: 'station', id: 'tra_1418'}
                    ],
                    station: {
                        "tra_1238": {x: pos.kaohsiung.x, y: pos.kaohsiung.y, name: '高雄', stationClass: 1, company: true, noDraw: true},
                        "tra_1419": {x: pos.kaohsiung.x+120, y: pos.kaohsiung.y, name: '民族', stationClass: 4 },
                        "tra_1420": {x: pos.kaohsiung.x+190, y: pos.kaohsiung.y, name: '科工館', stationClass: 4, company: true},
                        "tra_1421": {x: pos.kaohsiung.x+270, y: pos.kaohsiung.y, name: '正義', stationClass: 4 },
                        "tra_1402": {x: pos.kaohsiung.x+390, y: pos.kaohsiung.y, name: '鳳山', stationClass: 4, company: true},
                        "tra_1403": {x: pos.kaohsiung.x+490, y: pos.kaohsiung.y, name: '後庄', stationClass: 4 },
                        "tra_1404": {x: pos.pingdong.x-100, y: pos.pingdong.y, name: '九曲堂', stationClass: 4 },
                        "tra_1405": {x: pos.pingdong.x-50, y: pos.pingdong.y, name: '六塊厝', stationClass: 4 },
                        "tra_1406": {x: pos.pingdong.x, y: pos.pingdong.y, name: '屏東', stationClass: 2 },
                        "tra_1407": {x: pos.pingdong.x+50, y: pos.pingdong.y, name: '歸來', stationClass: 4 },
                        "tra_1408": {x: pos.pingdong.x+100, y: pos.pingdong.y, name: '麟洛', stationClass: 4 },
                        "tra_1409": {x: pos.pingdong.x+150, y: pos.pingdong.y, name: '西勢', stationClass: 4 },
                        "tra_1410": {x: pos.pingdong.x+200, y: pos.pingdong.y, name: '竹田', stationClass: 4 },
                        "tra_1411": {x: pos.pingdong.x+250, y: pos.pingdong.y, name: '潮州', stationClass: 2 },
                        "tra_1412": {x: pos.pingdong.x+250, y: pos.pingdong.y+30, name: '崁頂', stationClass: 4 },
                        "tra_1413": {x: pos.pingdong.x+250, y: pos.pingdong.y+60, name: '南州', stationClass: 4 },
                        "tra_1414": {x: pos.pingdong.x+250, y: pos.pingdong.y+90, name: '鎮安', stationClass: 4 },
                        "tra_1415": {x: pos.pingdong.x+250, y: pos.pingdong.y+120, name: '林邊', stationClass: 4 },
                        "tra_1416": {x: pos.pingdong.x+250, y: pos.pingdong.y+150, name: '佳冬', stationClass: 4 },
                        "tra_1417": {x: pos.pingdong.x+250, y: pos.pingdong.y+180, name: '東海', stationClass: 4 },
                        "tra_1418": {x: pos.pingdong.x+250, y: pos.pingdong.y+210, name: '枋寮', stationClass: 4 }
                    }
                }, {
                    id: "tra_yilan",
                    name: "[台鐵]宜蘭線",
                    ...
                    station: {
                        ...
                        "tra_1608": {x: pos.hualian.x, y: pos.hualian.y+190, name: '林榮新光', stationClass: 4},
                        "tra_1609": {x: pos.hualian.x, y: pos.hualian.y+220, name: '南平', stationClass: 4},
                        "tra_1610": {x: pos.hualian.x, y: pos.hualian.y+250, name: '鳳林', stationClass: 4},
                        "tra_1611": {x: pos.hualian.x, y: pos.hualian.y+280, name: '萬榮', stationClass: 4},
                        "tra_1612": {x: pos.hualian.x, y: pos.hualian.y+310, name: '光復', stationClass: 4},
                        "tra_1613": {x: pos.hualian.x, y: pos.hualian.y+340, name: '大富', stationClass: 4},
                        "tra_1614": {x: pos.hualian.x, y: pos.hualian.y+370, name: '富源', stationClass: 4},
                        "tra_1616": {x: pos.hualian.x, y: pos.hualian.y+400, name: '瑞穗', stationClass: 4},
                        "tra_1617": {x: pos.hualian.x, y: pos.hualian.y+430, name: '三民', stationClass: 4},
                        "tra_1619": {x: pos.hualian.x, y: pos.hualian.y+460, name: '玉里', stationClass: 4},
                        "tra_1621": {x: pos.hualian.x, y: pos.hualian.y+490, name: '東里', stationClass: 4},
                        "tra_1622": {x: pos.hualian.x, y: pos.hualian.y+520, name: '東竹', stationClass: 4},
                        "tra_1623": {x: pos.hualian.x, y: pos.hualian.y+550, name: '富里', stationClass: 4},
                    ...
                    line: [
                        {type: 'station', id: 'tra_1632'},
                        {type: 'station', id: 'tra_1507'},
                        {type: 'station', id: 'tra_1504'},
                        {type: 'station', id: 'tra_1418'}
                    ],
                    station: {
                        "tra_1632": {x: pos.taidong.x, y: pos.taidong.y, name: '台東', stationClass: 2, noDraw: true},
                        "tra_1517": {x: pos.taidong.x, y: pos.taidong.y+40, name: '康樂', stationClass: 4},
                        "tra_1516": {x: pos.taidong.x, y: pos.taidong.y+80, name: '知本', stationClass: 4},
                        "tra_1514": {x: pos.taidong.x, y: pos.taidong.y+120, name: '太麻里', stationClass: 4},
                        "tra_1512": {x: pos.taidong.x, y: pos.taidong.y+160, name: '金崙', stationClass: 4},
                        "tra_1510": {x: pos.taidong.x, y: pos.taidong.y+200, name: '瀧溪', stationClass: 4},
                        "tra_1508": {x: pos.taidong.x, y: pos.taidong.y+240, name: '大武', stationClass: 4},
                        "tra_1507": {x: pos.taidong.x, y: pos.taidong.y+280, name: '古莊', stationClass: 4},
                        "tra_1504": {x: pos.pingdong.x+460, y: pos.pingdong.y+210, name: '枋山', stationClass: 4},
                        "tra_1503": {x: pos.pingdong.x+400, y: pos.pingdong.y+210, name: '內獅', stationClass: 4},
                        "tra_1502": {x: pos.pingdong.x+320, y: pos.pingdong.y+210, name: '加祿', stationClass: 4},
                        "tra_1418": {x: pos.pingdong.x+250, y: pos.pingdong.y+210, name: '枋寮', stationClass: 4, noDraw: true}
                    }
                }, {
                    id: "tra_hai",
                    name: "[台鐵]海線",
                    ...
                    line: [
                        {type: 'station', id: 'tra_1028'},
                        {type: 'station', id: 'tra_1102'},
                        {type: 'station', id: 'tra_1109'},
                        {type: 'station', id: 'tra_1111'},
                        {type: 'station', id: 'tra_1112'},
                        {type: 'station', id: 'tra_1117'},
                        {type: 'station', id: 'tra_1118'},
                        {type: 'station', id: 'tra_1120'}
                    ],
                    station: {
                        "tra_1028": {x: pos.hsinchu.x, y: pos.hsinchu.y+110, name: '竹南', stationClass: 3, noDraw: true},
                        "tra_1102": {x: pos.hsinchu.x-80, y: pos.hsinchu.y+120, name: '談文', stationClass: 4 },
                        "tra_1104": {x: pos.hsinchu.x-120, y: pos.hsinchu.y+140, name: '大山', stationClass: 4 },
                        "tra_1105": {x: pos.hsinchu.x-160, y: pos.hsinchu.y+160, name: '後龍', stationClass: 4 },
                        "tra_1106": {x: pos.hsinchu.x-200, y: pos.hsinchu.y+180, name: '龍港', stationClass: 4 },
                        "tra_1107": {x: pos.hsinchu.x-240, y: pos.hsinchu.y+200, name: '白沙屯', stationClass: 4 },
                        "tra_1108": {x: pos.hsinchu.x-280, y: pos.hsinchu.y+220, name: '新埔', stationClass: 4 },
                        "tra_1109": {x: pos.hsinchu.x-320, y: pos.hsinchu.y+240, name: '通霄', stationClass: 4 },
                        "tra_1110": {x: pos.hsinchu.x-320, y: pos.hsinchu.y+280, name: '苑裡', stationClass: 4 },
                        "tra_1111": {x: pos.hsinchu.x-320, y: pos.hsinchu.y+320, name: '日南', stationClass: 4 },
                        "tra_1112": {x: pos.taichung.x-660, y: pos.taichung.y-160, name: '大甲', stationClass: 4 },
                        "tra_1113": {x: pos.taichung.x-660, y: pos.taichung.y-100, name: '臺中港', stationClass: 4 },
                        "tra_1114": {x: pos.taichung.x-660, y: pos.taichung.y-50, name: '清水', stationClass: 4 },
                        "tra_1115": {x: pos.taichung.x-660, y: pos.taichung.y, name: '沙鹿', stationClass: 4 },
                        "tra_1116": {x: pos.taichung.x-660, y: pos.taichung.y+60, name: '龍井', stationClass: 4 },
                        "tra_1117": {x: pos.taichung.x-660, y: pos.taichung.y+160, name: '大肚', stationClass: 4 },
                        "tra_1118": {x: pos.taichung.x-420, y: pos.taichung.y+220, name: '追分', stationClass: 4 },
                        "tra_1120": {x: pos.changhua.x, y: pos.changhua.y, name: '彰化', stationClass: 1, noDraw: true, company: true}
                    }
                }, {
                    id: "tra_pingxu",
                    ...
                    line: [
                        {type: 'station', id: 'tra_1215'},
                        {type: 'station', id: 'tra_ali9'},
                        {type: 'station', id: 'tra_ali13'},
                        {type: 'station', id: 'tra_ali17'},
                        {type: 'move', id: 'tra_alt1'},
                        {type: 'station', id: 'tra_alz2'}
                    ],
                    station: {
                        "tra_1215": {x: pos.chayi.x, y: pos.chayi.y, name: '嘉義', stationClass: 1, company: true, noDraw: true},
                        "tra_ali2": {x: pos.chayi.x+70, y: pos.chayi.y, name: '北門', stationClass: 4},
                        "tra_ali3": {x: pos.chayi.x+110, y: pos.chayi.y, name: '竹崎', stationClass: 4},
                        "tra_ali4": {x: pos.chayi.x+153, y: pos.chayi.y, name: '樟腦寮', stationClass: 4},
                        "tra_ali5": {x: pos.chayi.x+200, y: pos.chayi.y, name: '獨立山', stationClass: 4},
                        "tra_ali6": {x: pos.chayi.x+246, y: pos.chayi.y, name: '梨園寮', stationClass: 4},
                        "tra_ali7": {x: pos.chayi.x+292, y: pos.chayi.y, name: '交力坪', stationClass: 4},
                        "tra_ali8": {x: pos.chayi.x+338, y: pos.chayi.y, name: '水社寮', stationClass: 4},
                        "tra_ali9": {x: pos.chayi.x+390, y: pos.chayi.y, name: '奮起湖', stationClass: 3},
                        "tra_ali10": {x: pos.chayi.x+390, y: pos.chayi.y-25, name: '多林', stationClass: 4},
                        "tra_ali11": {x: pos.chayi.x+390, y: pos.chayi.y-50, name: '十字路', stationClass: 4},
                        "tra_ali12": {x: pos.chayi.x+390, y: pos.chayi.y-75, name: '屏遮那', stationClass: 4},
                        "tra_ali13": {x: pos.chayi.x+390, y: pos.chayi.y-100, name: '二萬坪', stationClass: 4},
                        "tra_ali14": {x: pos.chayi.x+435, y: pos.chayi.y-100, name: '神木', stationClass: 4},
                        "tra_ali15": {x: pos.chayi.x+480, y: pos.chayi.y-100, name: '阿里山', stationClass: 3},
                        "tra_ali16": {x: pos.chayi.x+530, y: pos.chayi.y-100, name: '沼平', stationClass: 3},
                        "tra_ali17": {x: pos.chayi.x+580, y: pos.chayi.y-100, name: '十字分道', stationClass: 4},
                        "tra_alt1": {x: pos.chayi.x+580, y: pos.chayi.y-125, name: '塔山', stationClass: 4},
                        "tra_alt2": {x: pos.chayi.x+580, y: pos.chayi.y-150, name: '眠月', stationClass: 4},
                        "tra_alt3": {x: pos.chayi.x+580, y: pos.chayi.y-175, name: '石猴', stationClass: 4},
                        "tra_alz1": {x: pos.chayi.x+580, y: pos.chayi.y-75, name: '對高岳', stationClass: 4},
                        "tra_alz2": {x: pos.chayi.x+580, y: pos.chayi.y-50, name: '祝山', stationClass: 4},
                    }
                }
            ],
            thsr: [
                {
                    ...
                    line: [
                        ...
                        {type: 'turn', id: 'thsr_03', ox: 175, oy: 0},
                    ...
                    station: {
                        ...
                        "thsr_03": {x: -300, y: 114, name: '板橋', stationClass: 1, company: true, noClick: true},
                        ...
                        "thsr_13": {x: pos.kaohsiung.x+50, y: pos.kaohsiung.y-200, name: '左營', stationClass: 4, company: true, noClick: true}
                    }
                }
            ],
            trtc: [
                {
                    ...
                    line: [
                        ...
                        {type: 'turn', id: 'trtc_051', ox:10, oy: 4},
                        {type: 'station', id: 'trtc_051'},
                        {type: 'turn', id: 'trtc_051', ox: -40, oy: 0},
                    ...
                    station: {
                        ...
                        "trtc_096": {x: 550, y: 60, name: '昆陽', stationClass: 4 },
                        "trtc_095": {x: 500, y: 60, name: '後山埤', stationClass: 4 },
                        ...
                        "trtc_088": {x: 90, y: 58, name: '善導寺', stationClass: 4 },
                        "trtc_051": {x: 0, y: 56, name: '台北車站', stationClass: 0, company: true },
                        "trtc_086": {x: -80, y: 100, name: '西門', stationClass: 3 },
                        "trtc_085": {x: -120, y: 138, name: '龍山寺', stationClass: 4 },
                        "trtc_084": {x: -175, y: 138, name: '江子翠', stationClass: 4 },
                        "trtc_083": {x: -220, y: 138, name: '新埔', stationClass: 4 },
                        "trtc_082": {x: -300, y: 138, name: '板橋', stationClass: 1, company: true },
                    ...
                    //"trtc_050","trtc_042","trtc_134","trtc_103","trtc_011","trtc_101","trtc_100","trtc_099"
                        "trtc_071": {x: -260, y: -325, name: '淡水', stationClass: 3 },
                        "trtc_070": {x: -210, y: -325, name: '紅樹林', stationClass: 4 },
                        "trtc_069": {x: -160, y: -325, name: '竹圍', stationClass: 4 },
                        "trtc_068": {x: -160, y: -300, name: '關渡', stationClass: 4 },
                    ...
                    station: {
                        ...
                        "trtc_032": {x: 100, y: 408, name: '小碧潭', stationClass: 4, noClick: true}
                    }
                }, {
                    id: "trtc_4",
                    name: "[北捷]中和新蘆線(4)",
                    ...
                    dir: "0",
                    line: [
                        {type: 'station', id: 'trtc_br01'},
                        {type: 'station', id: 'trtc_br02'},
                        {type: 'station', id: 'trtc_br03'},
                        {type: 'station', id: 'trtc_br06'},
                        {type: 'station', id: 'trtc_br07'},
                        {type: 'turn', id: 'trtc_br07', ox: -60, oy: 0},
                        {type: 'station', id: 'trtc_br08'},
                        {type: 'station', id: 'trtc_br14'},
                        {type: 'station', id: 'trtc_br15'},
                        {type: 'station', id: 'trtc_br19'},
                        {type: 'station', id: 'trtc_br20'},
                        {type: 'station', id: 'trtc_br21'},
                        {type: 'station', id: 'trtc_br22'},
                        {type: 'station', id: 'trtc_031'}
                    ],
                    station: {
                        "trtc_br01": {x: 400, y: 420, name: '動物園', stationClass: 3},
                        "trtc_br02": {x: 360, y: 380, name: '木柵', stationClass: 4},
                        "trtc_br03": {x: 340, y: 350, name: '萬芳社區', stationClass: 4},
                        "trtc_br04": {x: 340, y: 320, name: '萬芳醫院', stationClass: 4},
                        "trtc_br05": {x: 340, y: 290, name: '辛亥', stationClass: 4},
                        "trtc_br06": {x: 340, y: 260, name: '麟光', stationClass: 4},
                        "trtc_br07": {x: 280, y: 230, name: '六張犁', stationClass: 4},
                        "trtc_br08": {x: 220, y: 200, name: '科技大樓', stationClass: 4},
                        ...
                        "trtc_br12": {x: 220, y: -105, name: '中山國中', stationClass: 4},
                        "trtc_br13": {x: 220, y: -130, name: '松山機場', stationClass: 4},
                        "trtc_br14": {x: 220, y: -185, name: '大直', stationClass: 4},
                        "trtc_br15": {x: 300, y: -235, name: '劍南路', stationClass: 4},
                        "trtc_br16": {x: 350, y: -235, name: '西湖', stationClass: 4},
                        "trtc_br17": {x: 400, y: -235, name: '港墘', stationClass: 4},
                        "trtc_br18": {x: 450, y: -235, name: '文德', stationClass: 4},
                        "trtc_br19": {x: 500, y: -235, name: '內湖', stationClass: 4},
                        "trtc_br20": {x: 520, y: -205, name: '大湖公園', stationClass: 4},
                        "trtc_br21": {x: 540, y: -175, name: '葫洲', stationClass: 4},
                        "trtc_br22": {x: 550, y: -150, name: '東湖', stationClass: 4},
                        "trtc_br23": {x: 550, y: -85, name: '南港軟體園區', stationClass: 4},
                    ...
                    isPlanLine: false,
                    hasPlanLineRange: [
                        ['trtc_019', 'trtc_036'], ['trtc_y20','trtc_y09']
                    ],
                    nameTag: {
                        fontColor: '#425',
                        id:'trtc_y17', 
                    ...
                    line: [
                        ...
                        {type: 'station', id: 'trtc_y30'},
                        {type: 'station', id: 'trtc_y31'},
                        {type: 'station', id: 'trtc_y32'},
                        {type: 'station', id: 'trtc_y33'},
                        {type: 'station', id: 'trtc_y35'},
                        {type: 'station', id: 'trtc_y36'},
                        {type: 'station', id: 'trtc_094'},
                        {type: 'station', id: 'trtc_099'},
                        {type: 'station', id: 'trtc_y39'},
                        {type: 'station', id: 'trtc_019'},
                        {type: 'move', id: 'trtc_y35'},
                        {type: 'station', id: 'trtc_yt35'},
                        {type: 'station', id: 'trtc_yt36'},
                        {type: 'station', id: 'trtc_yt38'},
                        {type: 'station', id: 'trtc_013'},
                        {type: 'station', id: 'trtc_039'},
                        {type: 'station', id: 'trtc_yt42'},
                        {type: 'station', id: 'trtc_y09'}
                    ],
                    station: {
                        ...
                        "trtc_y08": {x: 75, y: 370, name: '十四張', stationClass: 4},
                        "trtc_y09": {x: 10, y: 360, name: '秀朗橋', stationClass: 4},
                        "trtc_y10": {x: -40, y: 350, name: '景平', stationClass: 4},
                        "trtc_047": {x: -90, y: 340, name: '景安', stationClass: 3, noDraw: true},
                        "trtc_y12": {x: -130, y: 270, name: '中和', stationClass: 3},
                        "trtc_y13": {x: -150, y: 240, name: '橋和', stationClass: 4},
                        "trtc_y14": {x: -180, y: 210, name: '中原', stationClass: 4},
                        "trtc_y15": {x: -210, y: 180, name: '板新', stationClass: 4},
                        "trtc_y16": {x: -300, y: 162, name: '板橋 (環狀)', stationClass: 1},
                        "trtc_y17": {x: -210, y: 70, name: '新埔民生', stationClass: 4},
                        "trtc_123": {x: -290, y: -20, name: '頭前庄', stationClass: 3, noDraw: true},
                        "trtc_y19": {x: -290, y: -50, name: '幸福', stationClass: 4},
                        "trtc_y20": {x: -270, y: -106, name: '新北產業園區', stationClass: 1, company: true},
                        ...
                        "trtc_y20a": {x: -270, y: -180, name: '中路', stationClass: 4, noClick: true, isPlanStation:true},
                ...
                //萬大線 a1d884 民汐線 25aae1 三鶯線 79bce8
                    ...
                    line: [
                        ...
                        {type: 'station', id: 'trtc_179'},
                        {type: 'move', id: 'trtc_lg08'},
                        {type: 'station', id: 'trtc_lg08a'},
                    ],
                    station: {
                        "trtc_042": {x: 10, y: 170, name: '中正紀念堂', stationClass: 3, noDraw: true},
                        "trtc_lg02": {x: -20, y: 197, name: '植物園', stationClass: 4, noClick: true},
                        "trtc_lg03": {x: -70, y: 197, name: '南機場', stationClass: 4, noClick: true},
                        "trtc_lg04": {x: -70, y: 220, name: '加蚋', stationClass: 4, noClick: true},
                        "trtc_lg05": {x: -75, y: 260, name: '永和', stationClass: 4, noClick: true},
                        "trtc_y11": {x: -130, y: 270, name: '中和', stationClass: 3, noDraw: true, noClick: true},
                        "trtc_lg07": {x: -150, y: 300, name: '雙和醫院', stationClass: 4, noClick: true},
                        "trtc_lg08": {x: -208, y: 300, name: '中和高中', stationClass: 4, noClick: true},
                        "trtc_lg08a": {x: -195, y: 275, name: '莒光', stationClass: 4, noClick: true},
                        "trtc_lg09": {x: -258, y: 300, name: '廷寮', stationClass: 4, noClick: true},
                        "trtc_lg10": {x: -250, y: 275, name: '中正國中', stationClass: 4, noClick: true},
                        "trtc_078": {x: -300, y: 275, name: '土城', stationClass: 4, noDraw: true},
                        "trtc_lg12": {x: -340, y: 300, name: '埤塘', stationClass: 4, noClick: true},
                    ...
                    station: {
                        ...
                        "trtc_y35": {x: 400, y: -135, name: '舊宗', stationClass: 3, noDraw: true, noClick: true},
                        "trtc_sb08": {x: 475, y: -135, name: '國防醫學中心', stationClass: 4, noClick: true},
                        "trtc_sb09": {x: 510, y: -110, name: '葫蘆洲', stationClass: 4, noClick: true},
            ...
            ntmetro: [
            	{
                    ...
                    dir: "1",
                    line: [
                        {type: 'station', id: 'ntmetro_V01'},
                        {type: 'station', id: 'ntmetro_V03'},
                        {type: 'station', id: 'ntmetro_V09'},
                        {type: 'station', id: 'ntmetro_V10'},
                        {type: 'station', id: 'ntmetro_V11'},
                        {type: 'move', id: 'ntmetro_V09'},
                        {type: 'station', id: 'ntmetro_V28'},
                        {type: 'station', id: 'ntmetro_V26'}
                    ],
                    station: {
                        "ntmetro_V01": {x: -210, y: -345, name: '輕軌紅樹林', stationClass: 5},
                        "ntmetro_V02": {x: -210, y: -365, name: '竿蓁林', stationClass: 5},
                        "ntmetro_V03": {x: -210, y: -385, name: '淡金鄧公', stationClass: 5},
                        "ntmetro_V04": {x: -260, y: -385, name: '淡江大學', stationClass: 5},
                        "ntmetro_V05": {x: -310, y: -385, name: '淡金北新', stationClass: 5},
                        "ntmetro_V06": {x: -360, y: -385, name: '新市一路', stationClass: 5},
                        "ntmetro_V07": {x: -420, y: -385, name: '淡水行政中心', stationClass: 5},
                        "ntmetro_V08": {x: -480, y: -385, name: '濱海義山', stationClass: 5},
                    ...
                    dir: "1",
                    line: [
                        {type: 'station', id: 'ntmetro_K9'},
                        {type: 'station', id: 'ntmetro_K3'},
                        {type: 'station', id: 'ntmetro_K1'}
                    ],
                    station: {
                        "ntmetro_K9": {x: 65, y: 390, name: '輕軌十四張', stationClass: 5},
                        "ntmetro_K8": {x: 65, y: 430, name: '新和國小', stationClass: 5},
                        "ntmetro_K7": {x: 65, y: 450, name: '陽光運動公園', stationClass: 5},
                        "ntmetro_K6": {x: 65, y: 470, name: '安康', stationClass: 5},
                        "ntmetro_K5": {x: 65, y: 490, name: '景文科大', stationClass: 5},
                        "ntmetro_K4": {x: 65, y: 510, name: '耕莘安康院區', stationClass: 5},
            ...
            tymetro: [
                {
                    ...
                    station: {
                        "tymetro_a01": {x: -0, y: -27, name: '臺北車站', stationClass: 0, company: true },
            ...
            krtc: [
                {
                    ...
                    line: [
                        ...
                        {type: 'station', id: 'krtc_R16'},
                        {type: 'station', id: 'krtc_R16'},
                        {type: 'station', id: 'krtc_R15'},
                        {type: 'station', id: 'krtc_R8'},
                        {type: 'station', id: 'krtc_R4A'},
                    ...
                    station: {
                        ...
                        "krtc_R21": {x: pos.kaohsiung.x-180, y: pos.kaohsiung.y-240, name: '都會公園', stationClass: 4},
                        "krtc_R20": {x: pos.kaohsiung.x-230, y: pos.kaohsiung.y-240, name: '後勁', stationClass: 4},
                        "krtc_R19": {x: pos.kaohsiung.x-230, y: pos.kaohsiung.y-218, name: '楠梓加工區', stationClass: 4},
                        "krtc_R18": {x: pos.kaohsiung.x-230, y: pos.kaohsiung.y-196, name: '油廠國小', stationClass: 4},
                        "krtc_R17": {x: pos.kaohsiung.x-180, y: pos.kaohsiung.y-196, name: '世運', stationClass: 4},
                        "krtc_R16": {x: pos.kaohsiung.x-23, y: pos.kaohsiung.y-196, name: '左營', stationClass: 3, company: true},
                        "krtc_R15": {x: pos.kaohsiung.x-15, y: pos.kaohsiung.y-170, name: '生態園區', stationClass: 4},
                        "krtc_R14": {x: pos.kaohsiung.x-15, y: pos.kaohsiung.y-145, name: '巨蛋', stationClass: 4},
                        "krtc_R13": {x: pos.kaohsiung.x-15, y: pos.kaohsiung.y-115, name: '凹子底', stationClass: 4},
                        "krtc_R12": {x: pos.kaohsiung.x-15, y: pos.kaohsiung.y-35, name: '後驛', stationClass: 4},
                        "krtc_R11": {x: pos.kaohsiung.x, y: pos.kaohsiung.y+28, name: '高雄', stationClass: 1, company: true},
                        "krtc_R10+O5": {x: pos.kaohsiung.x-15, y: pos.kaohsiung.y+55, name: '美麗島', stationClass: 3},
                        "krtc_R9": {x: pos.kaohsiung.x-15, y: pos.kaohsiung.y+80, name: '中央公園', stationClass: 4},
                        "krtc_R8": {x: pos.kaohsiung.x-15, y: pos.kaohsiung.y+105, name: '三多商圈', stationClass: 4},
                        "krtc_R7": {x: pos.kaohsiung.x+15, y: pos.kaohsiung.y+130, name: '獅甲', stationClass: 4},
                        "krtc_R6": {x: pos.kaohsiung.x+45, y: pos.kaohsiung.y+160, name: '凱旋', stationClass: 3},
                        "krtc_R5": {x: pos.kaohsiung.x+75, y: pos.kaohsiung.y+195, name: '前鎮高中', stationClass: 4},
                        "krtc_R4A": {x: pos.kaohsiung.x+105, y: pos.kaohsiung.y+220, name: '草衙', stationClass: 4},
                        "krtc_R4": {x: pos.kaohsiung.x+175, y: pos.kaohsiung.y+220, name: '高雄國際機場', stationClass: 4},
                        "krtc_R3": {x: pos.kaohsiung.x+235, y: pos.kaohsiung.y+220, name: '小港', stationClass: 4}
                    }
                }, {
                    id: "krtc_O",
                    name: "[高捷]橘線",
                    ...
                    dir: "0",
                    line: [
                        {type: 'station', id: 'krtc_O1'},
                        {type: 'station', id: 'krtc_O14'},
                        {type: 'station', id: 'krtc_OT1'}
                    ],
                    station: {
                        "krtc_O1": {x: pos.kaohsiung.x-265, y: pos.kaohsiung.y+55, name: '西子灣', stationClass: 4},
                        "krtc_O2": {x: pos.kaohsiung.x-120, y: pos.kaohsiung.y+55, name: '鹽埕埔', stationClass: 4},
                        "krtc_O4": {x: pos.kaohsiung.x-70, y: pos.kaohsiung.y+55, name: '市議會', stationClass: 4},
                        "krtc_R10+O5": {x: pos.kaohsiung.x-15, y: pos.kaohsiung.y+55, name: '美麗島', stationClass: 3, noDraw: true},
                        "krtc_O6": {x: pos.kaohsiung.x+40, y: pos.kaohsiung.y+55, name: '信義國小', stationClass: 4},
                        "krtc_O7": {x: pos.kaohsiung.x+100, y: pos.kaohsiung.y+55, name: '文化中心', stationClass: 4},
                        "krtc_O8": {x: pos.kaohsiung.x+170, y: pos.kaohsiung.y+55, name: '五塊厝', stationClass: 4},
                        "krtc_O9": {x: pos.kaohsiung.x+220, y: pos.kaohsiung.y+55, name: '技擊館', stationClass: 4},
                        "krtc_O10": {x: pos.kaohsiung.x+270, y: pos.kaohsiung.y+55, name: '衛武營', stationClass: 4},
                        "krtc_O11": {x: pos.kaohsiung.x+330, y: pos.kaohsiung.y+55, name: '鳳山西', stationClass: 4},
                        "krtc_O12": {x: pos.kaohsiung.x+390, y: pos.kaohsiung.y+55, name: '鳳山', stationClass: 4, company: true},
                        "krtc_O13": {x: pos.kaohsiung.x+450, y: pos.kaohsiung.y+55, name: '大東', stationClass: 4},
                        "krtc_O14": {x: pos.kaohsiung.x+500, y: pos.kaohsiung.y+55, name: '鳳山國中', stationClass: 4},
                        "krtc_OT1": {x: pos.kaohsiung.x+530, y: pos.kaohsiung.y+85, name: '大寮', stationClass: 4}
                    }
                }, {
                    id: "krtc_C",
                    name: "[高捷]環狀輕軌",
                    ...
                    dir: "1",
                    line: [
                        {type: 'station', id: 'krtc_C1'},
                        {type: 'station', id: 'krtc_C2'},
                        {type: 'station', id: 'krtc_C3'},
                        {type: 'station', id: 'krtc_C4'},
                        {type: 'station', id: 'krtc_C5'},
                        {type: 'station', id: 'krtc_C9'},
                        {type: 'station', id: 'krtc_C10'},
                        {type: 'station', id: 'krtc_C12'},
                        {type: 'station', id: 'krtc_C14'},
                        {type: 'station', id: 'krtc_C17'},
                        {type: 'station', id: 'krtc_C18'},
                        {type: 'station', id: 'krtc_C20'},
                        {type: 'station', id: 'krtc_C21A'},
                        {type: 'station', id: 'krtc_C21'},
                        {type: 'station', id: 'krtc_C22'},
                        {type: 'station', id: 'krtc_C27'},
                        {type: 'station', id: 'krtc_C30'},
                        {type: 'station', id: 'krtc_C31'},
                        {type: 'station', id: 'krtc_C33'},
                        {type: 'station', id: 'krtc_C34'},
                        {type: 'station', id: 'krtc_C37'},
                        {type: 'station', id: 'krtc_C1'}
                    ],
                    station: {
                        "krtc_C1": {x: pos.kaohsiung.x+145, y: pos.kaohsiung.y+160, name: '籬仔內', stationClass: 5},
                        "krtc_C2": {x: pos.kaohsiung.x+92, y: pos.kaohsiung.y+160, name: '凱旋瑞田', stationClass: 5},
                        "krtc_C3": {x: pos.kaohsiung.x+20, y: pos.kaohsiung.y+180, name: '前鎮之星', stationClass: 5},
                        "krtc_C4": {x: pos.kaohsiung.x-5, y: pos.kaohsiung.y+205, name: '凱旋中華', stationClass: 5},
                        "krtc_C5": {x: pos.kaohsiung.x-55, y: pos.kaohsiung.y+205, name: '夢時代', stationClass: 5},
                        "krtc_C6": {x: pos.kaohsiung.x-65, y: pos.kaohsiung.y+182, name: '經貿園區', stationClass: 5},
                        "krtc_C7": {x: pos.kaohsiung.x-75, y: pos.kaohsiung.y+159, name: '軟體園區', stationClass: 5},
                        "krtc_C8": {x: pos.kaohsiung.x-85, y: pos.kaohsiung.y+136, name: '高雄展覽館', stationClass: 5},
                        "krtc_C9": {x: pos.kaohsiung.x-95, y: pos.kaohsiung.y+113, name: '旅運中心', stationClass: 5},
                        "krtc_C10": {x: pos.kaohsiung.x-95, y: pos.kaohsiung.y+90, name: '光榮碼頭', stationClass: 5},
                        "krtc_C11": {x: pos.kaohsiung.x-155, y: pos.kaohsiung.y+90, name: '真愛碼頭', stationClass: 5},
                        "krtc_C12": {x: pos.kaohsiung.x-215, y: pos.kaohsiung.y+90, name: '駁二大義', stationClass: 5},
                        "krtc_C13": {x: pos.kaohsiung.x-215, y: pos.kaohsiung.y+68, name: '駁二蓬萊', stationClass: 5},
                        "krtc_C14": {x: pos.kaohsiung.x-215, y: pos.kaohsiung.y+41, name: '哈瑪星', stationClass: 5},
                        "krtc_C15": {x: pos.kaohsiung.x-205, y: pos.kaohsiung.y+20, name: '壽山公園', stationClass: 5},
                        "krtc_C16": {x: pos.kaohsiung.x-195, y: pos.kaohsiung.y-2, name: '文武聖殿', stationClass: 5},
                        "krtc_C17": {x: pos.kaohsiung.x-185, y: pos.kaohsiung.y-24, name: '鼓山區公所', stationClass: 5},
                        "krtc_C18": {x: pos.kaohsiung.x-175, y: pos.kaohsiung.y-46, name: '鼓山 (輕軌)', stationClass: 5},
                        "krtc_C19": {x: pos.kaohsiung.x-175, y: pos.kaohsiung.y-68, name: '馬卡道', stationClass: 5},
                        "krtc_C20": {x: pos.kaohsiung.x-175, y: pos.kaohsiung.y-90, name: '臺鐵美術館', stationClass: 5},
                        "krtc_C21A": {x: pos.kaohsiung.x-165, y: pos.kaohsiung.y-112, name: '美術館西', stationClass: 5},
                        "krtc_C21": {x: pos.kaohsiung.x-110, y: pos.kaohsiung.y-112, name: '美術館東', stationClass: 5},
                        "krtc_C22": {x: pos.kaohsiung.x-110, y: pos.kaohsiung.y-90, name: '聯合醫院', stationClass: 5},
                        "krtc_C23": {x: pos.kaohsiung.x-53, y: pos.kaohsiung.y-90, name: '龍華國小', stationClass: 5},
                        "krtc_C24": {x: pos.kaohsiung.x+6, y: pos.kaohsiung.y-90, name: '愛河之心', stationClass: 5},
                        "krtc_C25": {x: pos.kaohsiung.x+66, y: pos.kaohsiung.y-90, name: '新上國小', stationClass: 5},
                        "krtc_C26": {x: pos.kaohsiung.x+126, y: pos.kaohsiung.y-90, name: '灣仔內', stationClass: 5},
                        "krtc_C27": {x: pos.kaohsiung.x+186, y: pos.kaohsiung.y-90, name: '鼎山街', stationClass: 5},
                        "krtc_C28": {x: pos.kaohsiung.x+186, y: pos.kaohsiung.y-67, name: '高雄高工', stationClass: 5},
                        "krtc_C29": {x: pos.kaohsiung.x+186, y: pos.kaohsiung.y-44, name: '樹德家商', stationClass: 5},
                        "krtc_C30": {x: pos.kaohsiung.x+186, y: pos.kaohsiung.y-21, name: '科工館 (輕軌)', stationClass: 4},
                        "krtc_C31": {x: pos.kaohsiung.x+136, y: pos.kaohsiung.y+30, name: '聖功醫院 ', stationClass: 5},
                        "krtc_C32": {x: pos.kaohsiung.x+136, y: pos.kaohsiung.y+73, name: '凱旋公園', stationClass: 5},
                        "krtc_C33": {x: pos.kaohsiung.x+136, y: pos.kaohsiung.y+95, name: '衛生局', stationClass: 5},
                        "krtc_C34": {x: pos.kaohsiung.x+196, y: pos.kaohsiung.y+95, name: '五權國小', stationClass: 5},
                        "krtc_C35": {x: pos.kaohsiung.x+196, y: pos.kaohsiung.y+117, name: '凱旋五昌', stationClass: 5},
                        "krtc_C36": {x: pos.kaohsiung.x+196, y: pos.kaohsiung.y+139, name: '凱旋二聖', stationClass: 5},
                        "krtc_C37": {x: pos.kaohsiung.x+196, y: pos.kaohsiung.y+161, name: '輕軌機廠', stationClass: 5},
                    }
                }
            ]
        }
        ...
        ca.writeStation = function(ust){
            ...
            var offsetFontY = (st.stationClass==0) ? -2 : (st.stationClass==2) ? -1 : 0;
            ...
            cc.fillText(st.name, cube.x+1, cube.y+fontI+offsetFontY, maxWidth);
                ...
                for(var ata=0; ata<cpm.length; ata++){
                    ...
                    for(var k in tLine.station){
                        ...
                        tmpJ = $.extend({
                            ...
                            isNoClickLineStation: (tLine.isNoClickLine) ? true : false,
                            lineID: tLine.id
                        },tLine.station[k]);
                        if(tmpJ.company){
        ...
        ca.createClickDiv = function(){
            ...
            ca.writeAryStation.map(function(st){
                if(st.noDraw || st.noClick || st.isPlanStation || st.isNoClickLineStation) return false;
                cube = st.cube;
                ...
                if(cfg.stationNameRenderStyle==1 || cfg.stationNameRenderStyle==3){
                    var borderWidth = 1;
                    btn.style.width = cube.width*zw + borderWidth*2 + 'px';
                    btn.style.height = cube.height*zh + borderWidth*2 + 'px';
                    btn.style.left = cube.x*zw - borderWidth + 'px';
                    btn.style.top = cube.y*zh - borderWidth + 'px';
                }
