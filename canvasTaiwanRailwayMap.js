            ...
            tymetro: [
                {
                    ...
                    station: {
                        "tymetro_a01": {x: -10, y: -26, name: '臺北車站', stationClass: 1, company: true, noClick: true },
                        "tymetro_a02": {x: -150, y: -6, name: '三重', stationClass: 3, company: true, noClick: true},
                        "tymetro_a02a": {x: -220, y: -45, name: '二重', stationClass: 4, noClick: true},
                        "tymetro_a03": {x: -290, y: -80, name: '新北產業園區', stationClass: 1, company: true, noClick: true},
                        "tymetro_a04": {x: -350, y: -140, name: '新莊副都心', stationClass: 4, noClick: true},
                        "tymetro_a05": {x: -380, y: -110, name: '泰山', stationClass: 4, noClick: true},
                        "tymetro_a05a": {x: -410, y: -80, name: '輔大醫院', stationClass: 4, noClick: true},
                        "tymetro_a06": {x: -440, y: -50, name: '泰山貴和', stationClass: 4, noClick: true},
                        "tymetro_a07": {x: -550, y: -160, name: '體育大學', stationClass: 4, noClick: true},
                        "tymetro_a08": {x: -550, y: -110, name: '長庚醫院', stationClass: 3, noClick: true},
                        "tymetro_a09": {x: -550, y: -60, name: '林口', stationClass: 4, noClick: true},
                        "tymetro_a10": {x: pos.tauoyuan.x-310, y: pos.tauoyuan.y-120, name: '山鼻', stationClass: 4, noClick: true},
                        "tymetro_a11": {x: pos.tauoyuan.x-310, y: pos.tauoyuan.y-90, name: '坑口', stationClass: 3, noClick: true},
                        "tymetro_a12": {x: pos.tauoyuan.x-310, y: pos.tauoyuan.y-60, name: '機場第一航廈', stationClass: 3, noClick: true},
                        "tymetro_a13": {x: pos.tauoyuan.x-310, y: pos.tauoyuan.y-30, name: '機場第二航廈', stationClass: 3, noClick: true},
                        "tymetro_a14": {x: pos.tauoyuan.x-310, y: pos.tauoyuan.y+0, name: '機場第三航廈', stationClass: 3, noClick: true},
                        "tymetro_a14a": {x: pos.tauoyuan.x-310, y: pos.tauoyuan.y+30, name: '機場旅館', stationClass: 4, noClick: true},
                        "tymetro_a15": {x: pos.tauoyuan.x-310, y: pos.tauoyuan.y+60, name: '大園', stationClass: 4, noClick: true},
                        "tymetro_a16": {x: pos.tauoyuan.x-310, y: pos.tauoyuan.y+90, name: '橫山', stationClass: 4, noClick: true},
                        "tymetro_a17": {x: pos.tauoyuan.x-310, y: pos.tauoyuan.y+120, name: '領航', stationClass: 4, noClick: true},
                        "tymetro_a18": {x: pos.tauoyuan.x-310, y: pos.tauoyuan.y+150, name: '高鐵桃園站', stationClass: 2, noClick: true, company: true},
                        "tymetro_a19": {x: pos.tauoyuan.x-310, y: pos.tauoyuan.y+200, name: '桃園體育園區', stationClass: 3, noClick: true},
                        "tymetro_a20": {x: pos.tauoyuan.x-230, y: pos.tauoyuan.y+200, name: '興南', stationClass: 4, noClick: true},
                        "tymetro_a21": {x: pos.tauoyuan.x-190, y: pos.tauoyuan.y+200, name: '環北', stationClass: 4, noClick: true},
